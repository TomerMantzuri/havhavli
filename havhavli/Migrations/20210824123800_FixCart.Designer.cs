...
namespace havhavli.Migrations
{
    ...
    [Migration("20210824123800_FixCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("havhavli.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("havhavli.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("havhavli.Models.CartItem", b =>
                {
                    b.HasOne("havhavli.Models.Cart", "Cart")
                        .WithMany("CartItems")
                    ...
                    b.HasOne("havhavli.Models.Product", "Product")
                        .WithOne("cartItem")
                        .HasForeignKey("havhavli.Models.CartItem", "ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
